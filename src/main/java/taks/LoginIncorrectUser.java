...
public class LoginIncorrectUser implements Task {


    public static Performable LoginIncorrectUser(){
        return instrumented(LoginIncorrectUser.class);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        String username = Utils.nameGenerateError();
